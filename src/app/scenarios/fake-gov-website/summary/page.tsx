...
const mockPerformanceData = {
  ...
  actionsTaken: [
    "Correctly identified a fake government aid website.",
    "Recognized an official government domain for tax services."
  ],
  identifiedRisks: [
    {
      description: "A fake aid website using a non-'.gov.my' domain to collect personal data.",
      correctlyIdentified: true,
    },
     {
      description: "A suspicious 'loyalty program' asking for security question answers.",
      correctlyIdentified: true,
    }
  ],
  score: 100,
